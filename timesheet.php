  ...
  function drawChart() {
    ...
    dataTable.addRows([
      ...
      [ 'Dr.Meredith Grey', 'Clot Removal',            new Date(0,0,0,12,0,0),  new Date(0,0,0,13,0,0) ],
       ...
       [ 'Dr.Arizona Robbins',   'Frenulectomy',         new Date(0,0,0,12,0,0), new Date(0,0,0,13,0,0) ],
        [ 'Dr.Arizona Robbins',   'Splenectomy',         new Date(0,0,0,14,0,0), new Date(0,0,0,16,0,0) ],
      [ 'Dr.Alex Karev',   'Cholecystectomy',         new Date(0,0,0,13,0,0), new Date(0,0,0,16,30,0) ],
       ...
       [ 'Dr.Jackson Avery',   'Liposuction',         new Date(0,0,0,14,30,0), new Date(0,0,0,17,0,0) ],
      ...
      [ 'Dr.Owen Hunt',   'ER / Trauma',                  new Date(0,0,0,12,0,0), new Date(0,0,0,16,0,0) ],
