...
<div class="modal fade" id="editSectionModal<?php echo $section['nurse_id']; ?>" tabindex="-1" aria-labelledby="editSectionModalLabel<?php echo $instructor['doctor_id']; ?>" aria-hidden="true">
