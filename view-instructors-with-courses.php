...
<?php while ($instructor = $instructors->fetch_assoc())
   {
  ?>
     <div class="card border border-info m-2" style="background-color: #ffffff;">
     <div class="card-body">
...
<div class="d-flex justify-content-center mb-3">
 <div class="card" style="width: 100%; max-width: 800px; border: 3px solid #17a2b8; background-color: rgba(255, 255, 255, 0.8);">
   <div class="card-body">
