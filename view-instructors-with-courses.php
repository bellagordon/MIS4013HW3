 ...
 <?php while ($instructor = $instructors->fetch_assoc()) 
   ...
   ?>
      ...
      <div class="card-body">
        ...
        <button class="btn btn-light border border-info-subtle border-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo $instructor['doctor_id']; ?>" aria-expanded="false" aria-controls="collapse<?php echo $instructor['doctor_id']; ?>">
          View Patients
        </button>
