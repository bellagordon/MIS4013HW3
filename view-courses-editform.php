...
<button type="button" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#editCourseModal<?php echo $course['patient_id']; ?>" >
...
<div class="modal fade" id="editCourseModal<?php echo $course['patient_id']; ?>" tabindex="-1" aria-labelledby="editCourseModalLabel<?php echo $course['patient_id']; ?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editCourseModalLabel<?php echo $course['patient_id']; ?>">Edit Patient</h1>
